...
export default function ConnectionBar() {
  ...
  if (isReconnecting) {
    return (
      <div className="fixed top-2.5 right-14 md:right-4 z-40 flex items-center gap-2 bg-amber-950/90 border border-amber-500/40 text-amber-300 text-xs font-medium px-3 py-1 rounded-full shadow-lg backdrop-blur-sm animate-pulse">
  ...
  if (!isConnected) {
    return (
      <div className="fixed top-2.5 right-14 md:right-4 z-40 flex items-center gap-2 bg-red-950/90 border border-red-500/40 text-red-300 text-xs font-medium px-3 py-1 rounded-full shadow-lg backdrop-blur-sm">
  ...
  return (
    <div
      className={cn(
        "fixed top-2.5 right-14 md:right-4 z-40 flex items-center gap-1.5 bg-black/60 border text-xs font-medium px-2.5 py-1 rounded-full shadow-md backdrop-blur-sm transition-all select-none",
        colors.border,
        colors.text
      )}
